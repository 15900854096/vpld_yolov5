...
def fitness(x):
    ...
    #x=[P, R, mAP@0.5, mAP@0.95, mAP@0.5:0.95, fs_accuracy, loss_box, loss_obj, loss_cls]
    w = [0.0, 0.0, 0.1, 0.9, 0.1, 0.9]  # weights for [P, R, mAP@0.5,mAP@0.95, mAP@0.5:0.95, fs_accuracy]
    return (x[:, :6] * w).sum(1)
