...
class Loggers():
    ...
    def __init__(self, save_dir=None, weights=None, opt=None, hyp=None, logger=None, include=LOGGERS):
        ...
        self.keys = [
            ...
            'train/fs_loss',  # train loss
            'train/ss_box_loss',
            'train/ss_obj_loss',
            'train/ss_cls_loss',  # train loss
            'metrics/precision',
            'metrics/recall',
            'metrics/mAP_0.5',
            'metrics/mAP_0.95',
            ...
            'val/fs_loss',  # val loss
            'val/ss_box_loss',
            'val/ss_obj_loss',
            'val/ss_cls_loss',  # val loss
            'x/lr0',
            'x/lr1',
            'x/lr2']  # params
        self.best_keys = ['best/epoch', 'best/precision', 'best/recall', 'best/mAP_0.5','best/mAP_0.95', 'best/mAP_0.5:0.95', 'best/fs_accuracy']
        for k in LOGGERS:
